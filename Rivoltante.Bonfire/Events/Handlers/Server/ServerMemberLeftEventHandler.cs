...
public class ServerMemberLeftEventHandler(RevoltBonfireEventManager eventManager) : BonfireEventHandler<ServerMemberLeaveApiModel, ServerMemberLeftEventArgs>(eventManager)
{
