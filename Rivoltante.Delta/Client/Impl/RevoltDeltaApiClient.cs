...
public class RevoltDeltaApiClient(ILogger<RevoltDeltaApiClient> logger, Token token, IDeltaRateLimiter rateLimiter, JsonSerializerOptions serializerOptions)
    : IDeltaApiClient
{
